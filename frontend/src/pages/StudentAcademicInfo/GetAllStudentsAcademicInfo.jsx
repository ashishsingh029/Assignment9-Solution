                    ...
                    { students && Array.isArray(students) &&
                        students.map(student => (
                            <tr key = {student.rollno}>
                                ...
                                <td>
                                    <Link className = 'btn btn-info' to = {`/studentacademicinfo/read/${student.rollno}`}>View</Link>
                                    <Link className = 'btn btn-warning ms-1' to = {`/studentacademicinfo/update/${student.rollno}`}>Update</Link>
