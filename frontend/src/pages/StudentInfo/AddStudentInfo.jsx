...
const AddStudentInfo = () => {
    ...
    const handleSubmit = async event => {
        ...
        const newStudentInfo = {
            ...
            studentRoll: Number(studentRollRef.current.value),
            studentMobile: studentMobileRef.current.value,
            studentEmail: studentEmailRef.current.value,
            address: {
                studentCity: studentCityRef.current.value,
                studentState: studentStateRef.current.value,
                studentPincode: Number(studentPincodeRef.current.value)
            }
        }
